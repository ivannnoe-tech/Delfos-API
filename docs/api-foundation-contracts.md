...
| Semantic models                       | `POST /api/v1/semantic-models`, `GET /api/v1/semantic-models`, `GET /api/v1/semantic-models/:id`, `PATCH /api/v1/semantic-models/:id`, `DELETE /api/v1/semantic-models/:id`                                                                                                                                                                                     | Semantic Layer Foundation declarativa (measures, dimensions, glossário, governança) — metadata-only, sem semantic engine/SQL/execução. Ver [`ADR-0034`](./adr/adr-0034-semantic-layer-foundation-declarative-model.md). |
